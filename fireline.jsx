...
function GridCell({ cell, x, y, prediction, phase, onClick, cellSize }) {
  const t = cell.type;
  let bg;
  ...
  if (isCtrl) {
    overlay = (
      <div style={{
        ...
        background: `linear-gradient(135deg, ${C.ctrl1}, ${C.ctrl2})`,
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', gap: 16, alignItems: 'center', fontSize: 10, letterSpacing: '0.15em' }}>
          ...
          <div style={{
            ...
            color: phase === PH_SIM ? C.fire1 : phase === PH_RES ? C.mint : C.warning,
          }}>
